...
(function() {
    ...
    function initialize() {
        ...
        // Waltham, MA
        var map_options = {
            center: new google.maps.LatLng(42.418397,-71.258385),
            zoom: 15,
    ...
    var myLatlng = new google.maps.LatLng(42.2288677,-71.5199846); // Hopkinton, MA
    function init() {
        ...
        var contentString = '<div id="content">' +
            ...
            '<h4><i class="fa fa-car text-primary"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>Hopkinton, MA</b></h4>' +
            '<h4><i class="fa fa-envelope text-primary"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>scrumban@codegenesys.com</b></h4>' +
            '<h4><i class="fa fa-send text-primary"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>508.603.1400</b></h4><br>' +
            '<p>Interested in training, coaching or expert help? Just want to chat about an idea? <br>We\'d love to hear from you.</p>' +
            '</div>' +
            '</div>';
...
//            icon: 'img/map-marker.svg',
    ...
    // Flickr    
    $(function() {
        var id = '126565046@N04';  // CodeGenesys Flickr Account NSID
        var limit = '9';

        // Flickr Photostream feed link. id references CodeGenesys account
        $.getJSON("https://api.flickr.com/services/feeds/photos_public.gne?id=126565046@N04&lang=en-us&format=rss_200" + id + "&lang=en-us&format=json&jsoncallback=?",
